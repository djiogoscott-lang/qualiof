        ...
        <table className="w-full text-sm border-collapse">
          <thead className="bg-slate-900/60">
            <tr className="text-left text-[11px] uppercase tracking-wide text-slate-400">
              <th className="sticky left-0 bg-slate-900 z-10 px-2 py-2 border-b border-slate-700 w-10">
                <input
                  type="checkbox"
                  checked={allSelected}
              ...
              <th
                scope="col"
                className="sticky left-[40px] bg-slate-900 z-10 px-3 py-2 font-semibold text-slate-300 border-b border-slate-700 min-w-[180px]"
              >
                Apprenant
              </th>
              {columns.map((docType) => {
                ...
                return (
                  <th
                    key={docType}
                    scope="col"
                    className="px-1 py-2 font-semibold text-center border-b border-slate-700 min-w-[48px]"
                  >
                    <abbr
