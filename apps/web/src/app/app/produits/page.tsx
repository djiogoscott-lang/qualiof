    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          ...
          <div className="text-xs text-slate-500">tous produits, uniques</div>
        </div>
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          <div className="flex items-center gap-2 text-xs uppercase tracking-wide text-slate-500 mb-1">
            CA cumulé
          ...
          <div className="text-xs text-slate-500">HT inscriptions</div>
        </div>
        <div
        ...
        >
          <div
            className={`flex items-center gap-2 text-xs uppercase tracking-wide mb-1 ${
              catalogStats.aiDrafts > 0 ? 'text-amber-800' : 'text-slate-500'
            }`}
          >
          ...
          {rows.map((p) => {
            ...
            return (
              <Link
                ...
                className="rounded-2xl border border-slate-200 bg-white p-5 hover:border-primary/40 hover:shadow-sm transition-all"
              >
                ...
                <div className="flex items-center gap-3 text-xs border-t border-slate-200 pt-3 mb-2">
                  <span
                    className={`inline-flex items-center gap-1.5 font-medium ${
                      stats.learners > 0 ? 'text-slate-900' : 'text-slate-500/60'
                    }`}
                  >
                    <GraduationCap className="h-3.5 w-3.5" />
