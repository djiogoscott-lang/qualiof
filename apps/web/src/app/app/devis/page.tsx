    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <div className="ml-auto flex items-center gap-2 text-sm">
          <span className="text-slate-400">CA devis acceptés :</span>
      ...
      {rows.length === 0 ? (
        <div className="rounded-2xl border border-slate-700 bg-slate-800 p-12 text-center text-sm text-slate-400">
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {rows.map((q) => {
                ...
                return (
                  <tr key={q.id} className="border-b border-slate-700 hover:bg-slate-700/40 transition-colors">
                    ...
                    <td className="px-3 py-2">
                      ...
                      {q.recipientContact && (
                        <div className="text-xs text-slate-400">{q.recipientContact}</div>
                      )}
                    </td>
                    <td className="px-3 py-2 text-slate-400 line-clamp-1">{q.title}</td>
    ...
    <Link
      ...
      className={`inline-flex items-center gap-1.5 h-8 px-3 rounded-full text-sm border transition-colors ${
        active
          ...
          : 'border-slate-700 bg-slate-800 text-slate-100 hover:bg-slate-700/40'
      }`}
    >
      {label}
      <span
